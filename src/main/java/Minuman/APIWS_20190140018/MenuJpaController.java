...
import Minuman.APIWS_20190140018.exceptions.NonexistentEntityException;
import Minuman.APIWS_20190140018.exceptions.PreexistingEntityException;
...
public class MenuJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("Minuman_APIWS_20190140018_jar_0.0.1-SNAPSHOTPU");
